...
var companiesEmails []companiesEmail
...
func FindEmail() {
	...
	for index, row := range rows {
		...
		err = f.SetCellValue("Sheet1", cellE, uniqueEmailList)
...
//to use it you must need to change inside the for loop which is in line 73
